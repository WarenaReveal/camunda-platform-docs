...
To use an **AWS SQS Connector**, you need to have an SQS Queue and IAM key and secret pair with `sqs:SendMessage` policy relative to your SQS. See the [SQS Developer Guide](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-basic-examples-of-iam-policies.html) to learn more.
